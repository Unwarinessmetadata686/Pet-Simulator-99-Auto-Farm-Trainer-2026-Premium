...
import time
import offsets
from memory import GrindMaster

class GrindMasterApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Premium Pet Simulator 99 Auto Farm Trainer 2026")
...
if __name__ == "__main__":
    ...
    style.configure("TButton", background="#B22222", foreground="white")
    style.configure("TLabel", background="#1e1e1e", foreground="white")
    style.configure("TCheckbutton", background="#1e1e1e", foreground="white")
    app = GrindMasterApp(root)
    root.mainloop()
